 ...
 * <p>
 * It can be used to calculate updates for a RecyclerView Adapter. See {@code ListAdapter} and
 * {@code AsyncListDiffer} which can simplify the use of DiffUtil on a background thread.
 * <p>
 ...
 * <p>
 * Note that DiffUtil, {@code ListAdapter}, and {@code AsyncListDiffer} require the list to not
 * mutate while in use.
...
public class DiffUtil {
    ...
    public abstract static class Callback {
         ...
         * {@code RecyclerView.Adapter RecyclerView.Adapter}, you should
         ...
         * <p>
         * For example, if you are using DiffUtil with {@code RecyclerView}, you can return the
         * particular field that changed in the item and your
         * {@code RecyclerView.ItemAnimator ItemAnimator} can use that
     ...
     * {@code RecyclerView.Adapter} via {@code #dispatchUpdatesTo(RecyclerView.Adapter)}.
     */
